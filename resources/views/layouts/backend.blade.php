            ...
            >
                ...
                <div class="navbar-menu-wrapper d-flex align-items-top">
                    ...
                    <ul class="navbar-nav ms-auto">
                            ...
                            >
                                ...
                                <a class="dropdown-item preview-item">
                                    ...
                                    >
                                        ...
                                        <p class="fw-light small-text mb-0">
                                            This is a Bundle featuring 16 unique
                                            dashboards
                                        </p>
                                    </div>
                                </a>
                                <a class="dropdown-item preview-item">
                                    ...
                                    >
                                        ...
                                        <p class="fw-light small-text mb-0">
                                            Everything you’ll ever need for your
                                            Angular projects
                                        </p>
                                    </div>
                                </a>
                                ...
                                <a class="dropdown-item preview-item">
                                    ...
                                    >
                                        ...
                                        <p class="fw-light small-text mb-0">
                                            Bundle of 8 Premium React Admin
                                            Dashboard
                                        </p>
                                    </div>
                                </a>
                            ...
                            >
                                ...
                                <a class="dropdown-item preview-item py-3">
                                    ...
                                    <div class="preview-item-content">
                                        <h6
                                            class="preview-subject fw-normal text-dark mb-1"
                                        >
                                            Application Error
                                        </h6>
                                        <p class="fw-light small-text mb-0">
                        ...
                        <li
                            class="nav-item dropdown d-none d-lg-block user-dropdown"
                        >
                            <a
                                class="nav-link"
                                id="UserDropdown"
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="theme-setting-wrapper">
                    ...
                    <div id="theme-settings" class="settings-panel">
                        ...
                        >
                            <div
                                class="img-ss rounded-circle bg-light border me-3"
                            ></div>
                            Light
                        </div>
                        <div class="sidebar-bg-options" id="sidebar-dark-theme">
                            <div
                                class="img-ss rounded-circle bg-dark border me-3"
                            ></div>
                            Dark
                        </div>
                ...
                <div id="right-sidebar" class="settings-panel">
                    ...
                    <div class="tab-content" id="setting-content">
                        ...
                        >
                            ...
                            <h4 class="px-3 text-muted mt-5 fw-light mb-0">
                                Events
                            </h4>
                            <div class="events pt-4 px-3">
                                <div class="wrapper d-flex mb-2">
                                    <i
                                        class="ti-control-record text-primary me-2"
                                    ></i>
